 ...
 * @param {Function} callback
 */
Confluence.prototype.getLabelById = function(id, callback){

    request
        .get(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/label" +  this.config.extension + "?expand=body.storage,version")
        .auth(this.config.username, this.config.password)
        .end(function(err, res){
            processCallback(callback, err, res);
        });
...
/**
 * Post Label for  a specific page
 *
 * @param {string} id
 * @param {Function} callback
 */
Confluence.prototype.postLabelById = function(id, label, callback){

    request
        .post(this.config.baseUrl + this.config.apiPath + "/content/" + id + "/label" +  this.config.extension + "?expand=body.storage,version")
        .auth(this.config.username, this.config.password)
        .type('json')
        .send(label)
        .end(function(err, res){
 ...
 * @param {Function} callback
 */
Confluence.prototype.postPage = function(page, parentId, callback){
    var config = this.config;
